...
*/
    ...
    public Empresa(String name, String document, String phone, String address, String users, String transactions){//, List<Employee> employeeList, List<Transaction> transactionList, LocalDate createdAt, LocalDate updateAt) {
        this.name = name;
